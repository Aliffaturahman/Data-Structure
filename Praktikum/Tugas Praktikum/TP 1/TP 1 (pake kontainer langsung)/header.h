...
void addFirst(Jujutsu data, list *L);               // Prosedur Untuk Menambahkan Elemen Di Awal
void addAfter(elemen *prev, Jujutsu data, list *L); // Prosedur Untuk Menambahkan Elemen Di Tengah
void addLast(Jujutsu data, list *L);                // Prosedur Untuk Menambahkan Elemen Di Akhir

...
void addFirst(char Penyihir[], char Technique[], int Power, list *L){
    elemen* baru;
    baru = (elemen*) malloc (sizeof (elemen));

    strcpy(baru->kontainer.Penyihir, Penyihir);
...
void addAfter(elemen *prev, char Penyihir[], char Technique[], int Power, list *L){
...
void addLast(char Penyihir[], char Technique[], int Power, list *L){
    if((*L).first == NULL){
        /*proses jika list masih kosong*/
        addFirst(Penyihir, Technique, Power, L);
    }
    else{
        ...
        addAfter(prev, Penyihir, Technique, Power, L);
    }
}
